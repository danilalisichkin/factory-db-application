...
INSERT INTO public.clients (phone_number, organization_name, email, legal_address) VALUES
    ('+375 29 111-11-11', 'ОАО "АМИ Мебель"', 'ami@gmail.com', 'г. Дзержинск, ул. Ленина 12'),
    ('+375 33 122-34-45', 'ООО "АйТи Решения"', 'itsolutions@gmail.com', 'г. Минск, ул. Интернациональная 14, о. 4'),
    ('+375 44 111-44-44', 'ГУО "СШ 15 г. Минска"', 'shool15minsk@mail.ru', 'г. Минск, ул. Калинина 52');

INSERT INTO public.product_orders (client_phone_number, product_sku, quantity) VALUES
    ('+375 29 111-11-11', 1, 2),
    ('+375 29 111-11-11', 2, 10),
    ('+375 29 111-11-11', 3, 10),
    ('+375 29 111-11-11', 4, 4),
    ('+375 33 122-34-45', 5, 10),
    ('+375 44 111-44-44', 3, 3),
    ('+375 44 111-44-44', 5, 10);